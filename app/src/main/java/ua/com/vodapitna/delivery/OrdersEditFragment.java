...
public class OrdersEditFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View customDialogView = inflater.inflate(R.layout.orders_edit_fragment,
                null);
        ...
        Button orderOkButton = (Button) customDialogView.findViewById(R.id.button_ok);
        Button orderCancelButton = (Button) customDialogView.findViewById(R.id.button_cancel);
